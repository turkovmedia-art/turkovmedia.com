...
function setupCustomVideoLoader(plyrInstance, container) {
    ...
    if (!loaderOverlay) {
        ...
        loaderOverlay.className = 'plyr-custom-loader-overlay initial-load';
        loaderOverlay.innerHTML = `<video src="${LOADER_WEBM_BASE64}" autoplay loop muted playsinline style="width: 100px; height: 100px; object-fit: contain;"></video>`;
    ...
    loaderOverlay.classList.add('initial-load');
    showLoader();
    ...
    const registerListeners = () => {
        ...
        plyrInstance.on('playing', () => {
            isStalled = false;
            loaderOverlay.classList.remove('initial-load');
            hideLoader();
    ...
    if (ytId) {
        ...
        container.innerHTML = `
            <div class="plyr__video-embed" id="custom-youtube-player" style="width: 100%; height: 100%;">
                <iframe
                    src="https://www.youtube.com/embed/${ytId}?origin=https://plyr.io&iv_load_policy=3&modestbranding=1&playsinline=1&showinfo=0&rel=0&enablejsapi=1&autoplay=1"
                    allowfullscreen
                    allowtransparency
